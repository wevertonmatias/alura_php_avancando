...
function exibirMensagem(string $message)
{
...
function depositar(array $conta, float $valor): array 
{
    if($valor > 0){
        ...
        exibirMensagem("Depósito precisar ser positivo.");
    }
    return $conta;
}
...
// $contas['222.222.222-22'] = sacar($contas['222.222.222-22'], 'três');
$contas['222.222.222-22'] = sacar($contas['222.222.222-22'], 500);
// $contas['333.333.333-33'] = depositar($contas['333.333.333-33'], -150);
$contas['333.333.333-33'] = depositar($contas['333.333.333-33'], 150);
